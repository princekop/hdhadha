...
const ElectricBorder: React.FC<ElectricBorderProps> = ({
  ...
  const updateAnim = () => {
    ...
    if (filterEl) {
      (filterEl as SVGFilterElement).setAttribute("x", "-200%");
      (filterEl as SVGFilterElement).setAttribute("y", "-200%");
      (filterEl as SVGFilterElement).setAttribute("width", "500%");
      (filterEl as SVGFilterElement).setAttribute("height", "500%");
    }
